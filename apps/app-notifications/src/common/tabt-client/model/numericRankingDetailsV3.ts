 ...
 */
import { NumericRankingPerWeekOpponentsV3 } from './numericRankingPerWeekOpponentsV3';

export interface NumericRankingDetailsV3 {
  date: string;
  competitionType: NumericRankingDetailsV3.CompetitionTypeEnum;
  competitionContext: string;
  basePoints: number;
  endPoints: number;
  opponents: Array<NumericRankingPerWeekOpponentsV3>;
}
export namespace NumericRankingDetailsV3 {
  export type CompetitionTypeEnum = 'championship' | 'tournament';
  export const CompetitionTypeEnum = {
    Championship: 'championship' as CompetitionTypeEnum,
    Tournament: 'tournament' as CompetitionTypeEnum,
  };
}
