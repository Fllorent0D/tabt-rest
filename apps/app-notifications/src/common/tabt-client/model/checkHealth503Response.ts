 ...
 */
import { CheckHealth200ResponseInfoValue } from './checkHealth200ResponseInfoValue';

export interface CheckHealth503Response {
  status?: string;
  info?: { [key: string]: CheckHealth200ResponseInfoValue } | null;
  error?: { [key: string]: CheckHealth200ResponseInfoValue } | null;
  details?: { [key: string]: CheckHealth200ResponseInfoValue };
}
