...
export class DivisionsService {
    ...
    return accessTokenObservable.pipe(
      switchMap((accessToken) => {
        ...
        return this.httpClient.get<Array<TeamMatchesEntry>>(
          `${this.basePath}/v1/divisions/${encodeURIComponent(String(divisionId))}/matches`,
          {
            params: queryParameters,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
    ...
    return accessTokenObservable.pipe(
      switchMap((accessToken) => {
        ...
        return this.httpClient.get<Array<MemberResults>>(
          `${this.basePath}/v1/divisions/${encodeURIComponent(String(divisionId))}/members/ranking`,
          {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
          },
  ...
  public findDivisionRanking(
    ...
    if (rankingSystem !== undefined && rankingSystem !== null) {
      queryParameters.append('rankingSystem', <any>rankingSystem);
    }
    ...
    return accessTokenObservable.pipe(
      switchMap((accessToken) => {
        ...
        return this.httpClient.get<Array<RankingEntry>>(
          `${this.basePath}/v1/divisions/${encodeURIComponent(String(divisionId))}/ranking`,
          {
            params: queryParameters,
            withCredentials: this.configuration.withCredentials,
            headers: headers,
