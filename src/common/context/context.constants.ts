...
export const TABT_HEADERS = [HeaderKeys.X_TABT_ACCOUNT, HeaderKeys.X_TABT_PASSWORD, HeaderKeys.X_TABT_ONBEHALFOF, HeaderKeys.X_TABT_DATABASE, HeaderKeys.X_FORWARDED_FOR, HeaderKeys.X_TABT_SEASON];
